...
namespace API.Controllers
{
    ...
    public class CONDIV_CONVERTIRMONEDAController : ControllerBase
    {
        ...
        public async Task<ActionResult<CONDIV_TC_TIPO_CAMBIO>> PostCONDIV_TC_TIPO_CAMBIO(CONDIV_CONVERTIR_MONEDA CONDIV_CONVERTIR_MONEDA)
        {
            ...
            decimal MONTO_SALIDA = CONDIV_BOL_CONVERTIR_MONEDA.CONVERTIR_MONEDA(CONDIV_CONVERTIR_MONEDA.ID_MONEDA_ORIGEN, CONDIV_CONVERTIR_MONEDA.ID_MONEDA_DESTINO, CONDIV_CONVERTIR_MONEDA.ID_CATEGORIA_CAMBIO, CONDIV_CONVERTIR_MONEDA.MONTO);
            int ID_TIPO_CAMBIO = CONDIV_BOL_CONVERTIR_MONEDA.GET_ID_TIPO_CAMBIOO(CONDIV_CONVERTIR_MONEDA.ID_MONEDA_ORIGEN, CONDIV_CONVERTIR_MONEDA.ID_MONEDA_DESTINO, CONDIV_CONVERTIR_MONEDA.ID_CATEGORIA_CAMBIO, CONDIV_CONVERTIR_MONEDA.MONTO);
